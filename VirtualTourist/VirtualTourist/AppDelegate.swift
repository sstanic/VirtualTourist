...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func checkIfFirstLaunch() {
        if UserDefaults.standard.bool(forKey: Constants.HasLaunchedBefore) {
            ...
            UserDefaults.standard.set(37.773972, forKey: Constants.MapLatitude)
            UserDefaults.standard.set(-122.431297, forKey: Constants.MapLongitude)
            UserDefaults.standard.set(2.8, forKey: Constants.MapLatitudeDelta)
            UserDefaults.standard.set(2.1, forKey: Constants.MapLongitudeDelta)
        }
    }
