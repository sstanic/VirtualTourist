...
//        // The directory the application uses to store the Core Data store file. This code uses a directory named "Sascha-Stanic.VirtualTourist" in the application's documents Application Support directory.
